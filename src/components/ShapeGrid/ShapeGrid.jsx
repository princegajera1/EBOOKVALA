...
const ShapeGrid = ({
  ...
  // Make colors responsive to the EBOOKVALA theme when defaults are used
  const isDarkMode = theme === 'dark';
  const resolvedBorderColor = isDarkMode ? 'rgba(255, 255, 255, 0.05)' : 'rgba(17, 24, 39, 0.04)';
  const resolvedHoverFillColor = isDarkMode ? 'rgba(255, 255, 255, 0.08)' : 'rgba(17, 24, 39, 0.06)';

  const activeBorder = borderColor === '#999' ? resolvedBorderColor : borderColor;
  const activeHoverFill = hoverFillColor === '#222' ? resolvedHoverFillColor : hoverFillColor;
  ...
  useEffect(() => {
    ...
    const drawGrid = () => {
      ...
      // Dark Luxury ink style gradient
      if (isDarkMode) {
  ...
  }, [direction, speed, activeBorder, activeHoverFill, squareSize, shape, hoverTrailAmount, theme]);
